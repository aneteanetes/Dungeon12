namespace Dungeon12.Drawing.SceneObjects
{
    ...
    public class MetallButtonControl : ButtonControl
    {
        ...
        public override string Image { get; set; } = "Dungeon.Resources.Images.ui.button.png";
        
        public override void Focus()
        {
            Global.AudioPlayer.Effect("focus");
            this.Image = "Dungeon.Resources.Images.ui.button_f.png";
            //this.textControl.Text.Paint(ActiveColor, true);
        }

        public override void Unfocus()
        {
            this.Image = "Dungeon.Resources.Images.ui.button.png";
