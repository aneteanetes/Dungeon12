            ...
            set
            {
                if (value)
                {
                    if (!autofocus)
                    {
                        ...
                        freezing = true;
                        Dungeon.DungeonGlobal.Freezer.FreezeHandle(ControlEventType.Key, this);
                        Dungeon.DungeonGlobal.BlockSceneControls = true;
                    }
                }
                else
                {
                    if (!autofocus)
                    {
                        ...
                        Dungeon.DungeonGlobal.Freezer.UnfreezeHandle(ControlEventType.Key, this);
                        Dungeon.DungeonGlobal.BlockSceneControls = false;
                    }
                }
