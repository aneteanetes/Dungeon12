        ...
        private class MapRegionPoint : SceneControl<MapPoint>, ITooltipedDrawText
        {
            ...
            public MapRegionPoint(MapPoint component, MapRegion region) : base(component)
            {
                ...
                switch (component.Fraction)
                {
                    ...
                    case Entities.Enums.Fraction.MageCircle: frac = "_m"; break;
                    case Entities.Enums.Fraction.ShadowGuild: frac = "_r"; break;
                    case Entities.Enums.Fraction.Exarchate: frac = "_e"; break;
                    case Entities.Enums.Fraction.DeathCult: frac = "_c"; break;
