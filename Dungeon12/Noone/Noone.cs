namespace Dungeon12.Noone
{
    ...
    public class Noone : Dungeon12Class
    {
        ...
        [ClassStat("Паррирование", ConsoleColor.Yellow, 1, "При атаке есть шанс равный паррированию что полученный удар в ближнем бою станет скользящими - нанесёт только половину урона, а время восстановления атаки сбросится.")]
        public long Parry { get; set; } = 200;
