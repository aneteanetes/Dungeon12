...
namespace InTheWood.Shaders.Bloom
{
    public class BloomFilter : IEffect, IMonogameEffect, IDisposable
    {
        public BloomFilter()
        {
        ...
        public string Name => "In-Build Bloom Effect";
        ...
        public void Load(XNADrawClient client)
        {
            ...
            UpdateResolution(client.GraphicsDevice.Viewport.Width, client.GraphicsDevice.Viewport.Height);
        ...
        public Action<BloomFilter> AfterLoad;
