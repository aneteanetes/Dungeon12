...
namespace Dungeon12.SceneObjects.MUD
{
    internal class ResourcePanel : SceneControl<Party>
    {
        ...
        //private class FameSceneObject : SceneControl<Party>, IMouseHint, ITooltiped, ICursored
        //{
        //    private TextObject valueObj;

        //    public FameSceneObject(Party comp):base(comp)
        //    {
        //        this.Height = 20;
        //        this.AddChild(new ImageObject("Icons/MUD/glory.tga") { Width=20, Height=20 });

        //        var txt = comp.Fame.Common.ToString().AsDrawText().InBold().InSize(18).Calibri();
        //        valueObj = this.AddTextCenter(txt, false);
        //        valueObj.Left = 22;
        ...
        //    public string TooltipText => $"{Global.Strings["Glory"]} ({Global.Strings["RightMouseButton"]} - {Global.Strings["Info"]})";

        //    public CursorImage Cursor => CursorImage.Question;

        //    public override void Update(GameTimeLoop gameTime)
        //    {
        //        valueObj.SetText(Component.Fame.Common.ToString());
        //        base.Update(gameTime);
        //    }

        //    public ISceneObjectHosted CreateMouseHint() => new FameTooltip(Component.Fame);

        //    private class FameTooltip : SceneObject<Fame>, ISceneObjectHosted
        //    {
        //        public FameTooltip(Fame component) : base(component)
        //        {
        //            this.Height = 50;
        //            this.Width = 35*4;

        //            var txt = CommonDrawText(Global.Strings["Glory"]+$": {component.Name()}");
        //            this.Width = this.MeasureText(txt).X+10;
        //            this.AddBorder();

        //            var text = this.AddTextCenter(txt, true, false);
        //            text.Top=5;

        //            this.AddChild(new FameObj(FameType.Good, component.Good) { Left = 5, Top = 35 });

        //            this.AddChild(new FameObj(FameType.Evil, component.Evil) { Left = 35, Top = 35 });

        //            this.AddChild(new FameObj(FameType.Trick, component.Trick) { Left = 70, Top = 35 });

        //            this.AddChild(new FameObj(FameType.Wisdom, component.Wisdom) { Left = 105, Top = 35 });
        //        }

        //        public ISceneObject Host { get; set; }

        //        private class FameObj : SceneControl<Fame>
        //        {
        //            private TextObject txt;
        //            private FameType type;

        //            public FameObj(Fame fame, FameType type):base(fame)
        //            {
        //                this.type=type;
        ...
        //                txt = this.AddText(CommonDrawText(fame[type].ToString()), 35, 0);
        //            }
