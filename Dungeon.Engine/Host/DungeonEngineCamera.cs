    ...
    public class DungeonEngineCamera : ICamera
    {
        ...
        public Square CameraView
        {
            get
            {
                ...
                if (bounds == null)
                {
                    return new Square(0, 0, host.ActualWidth, host.ActualHeight);
                }
                var value = bounds.Value;
                return new Square(value.X, value.Y, value.Width, value.Height);
            }
        }

        Square ICamera.CameraView => throw new NotImplementedException();
        ...
        public bool InCamera(ITile tile)
        {
            throw new NotImplementedException();
        }
    }
